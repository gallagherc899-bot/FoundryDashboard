...
# ============================================================================
# Louit, Pascual & Jardine (2009) model-selection screening — per part
# Trend gate (Laplace, HPP null) + Lewis-Robinson (RP null, CV-corrected),
# then exponential probability-plot r^2. Sample-size gated for honest reporting.
# ============================================================================
...
Model learns **systemic process signatures**, not part identities (Deming, 1986).
    ...
    with tab3:
        ...
        st.markdown("---")
        st.caption("Legacy hazard-stability diagnostics (CV / Kendall / χ²) retained below for reference.")
